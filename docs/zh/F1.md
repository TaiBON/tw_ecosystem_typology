...
河溪生物群系中包含由上游或地下流入三角洲、河口及湖泊的流水環境。 河溪生物群具有單向的線性流動模式且與周遭地景有密切交互作用。 分水嶺劃分河川集水區。 河溪系統由不同級別的河道構成，一級河道不具有支流，二級河道由一級河道組成，三級河道由二級河道構成，以此類推。 世界最大的河川由10-12級的河道組成。 除了人為調節及地下水補給的河川，全年度、季節性及偶發性的河川流動模式變化能依據集水區的河道級別及降雨模式產生變化。 河道梯度決定流速及擾動、河岸及基質結構、棲地變化；流量取決於地區氣候及短期天氣狀態， 乾旱區域的河川可能會乾涸數年。 上述因子能區分不同流動模式、高地及低地的流水生態系統及生物性狀。 鄰近河岸及上游集水區的有機質提供異源能量，並由生物膜及浮游植物合成，使生產力從上游至下游處漸增。 在大且緩的下游河川中，浮游植物能攜帶並分解較小的有機質顆粒。 集水區的河道位置及梯度決定侵蝕及堆積作用，也對下游的養分、有機質及周圍陸地及河溪生態系統的物質交換極為重要。 人為活動的養分在下游處增加並依土地利用變化。 集水區中有大量泥炭地的河川富含丹寧，能使減少光穿透水柱、酸性增加、促進微生物活動以增加有機碳的溶解，進而減少氧氣含量、生產力及生物多樣性，但生物特有性可能較高。 在冬季結冰的氣候下，河川的生產力及流動受到季節性限制， 多數生物棲息於河川底。 大型河川因資源可用性高、多樣化棲地及物種-集水區關係密切，使營養網絡較為複雜。 腐食性無脊椎動物取食有機質碎片並提供資源給大型無脊椎掠食者及魚類，進而供給更大型的掠食性魚類、水鳥、爬蟲類及部分哺乳類食物來源。 Specialised species-level traits are associated with different flow regimes and life history strategies often align with patterns of resource availability. For example, suspension feeding is common in high flow velocities, cold tolerance and seasonal dormancy occur in freeze-thaw streams, life cycles are geared to autumnal leaf fall in temperate forested catchments, and desiccation tolerance and dormant life stages dominate in episodic rivers.
