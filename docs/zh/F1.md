...
河溪生物群系中包含由上游或地下流入三角洲、河口及湖泊的流水環境。 河溪生物群具有單向的線性流動模式且與周遭地景有密切交互作用。 分水嶺劃分河川集水區。 河溪系統由不同級別的河道構成，一級河道不具有支流，二級河道由一級河道組成，三級河道由二級河道構成，以此類推。 世界最大的河川由10-12級的河道組成。 除了人為調節及地下水補給的河川，全年度、季節性及偶發性的河川流動模式變化能依據集水區的河道級別及降雨模式產生變化。 河道梯度決定流速及擾動、河岸及基質結構、棲地變化；流量取決於地區氣候及短期天氣狀態， 乾旱區域的河川可能會乾涸數年。 These factors act as selection filters, differentiating lotic ecosystems and their species’ traits amongst flow regimes, and between uplands and lowlands. Productivity tends to increase from uplands to lowlands and is driven both by allochthonous energy sources that contribute coarse organic matter from terrestrial ecosystems in adjacent riparian zones and upper catchments, and by autochthonous energy synthesis by biofilms or phytoplankton. Phytoplankton is important downstream in larger, slower rivers that carry smaller organic particles and more dissolved organic matter. Erosion and depositional processes depend on the gradient
