...
湖泊生物群系涵蓋不流動水體的靜水生態系。 各地的湖泊生態系統在面積、深度、水文狀態及與其他水體的連通性差異甚大。 水文變化、溫度、湖泊大小以及鹽度（與鹽類成分）的梯度變化對湖泊生態系的功能、生產力、生物多樣性與營養階層結構具有重要影響。 水文狀況從全年開闊水面到季節性或間歇性的蓄水與乾涸。 湖泊跨越全球氣候梯度，其水文受到集水區降水與蒸散速率影響，並受緯度與海拔造成的季節性凍融影響。 然而，湖泊生物群系展現出非區域性的特質，主因在於地下水、地形與基質對氣候的緩衝作用。 緩衝作用於自流泉、綠洲與地熱濕地中最為明顯，因水源多不依賴氣候。 湖泊與集水區的基質影響營養鹽量與鹽度，但濃度會依水文狀況與水體混合程度而變化。 深水湖與凍融湖常出現分層現象，導致營養鹽、氧氣與溫度具有深度梯度變化。 最深的湖泊可延伸至無光帶。 生產力來自集水區的異源性輸入以及浮游植物、附生藻類（如 生物膜）、沉水、浮水與挺水大型植物等的自營生產。 Trophic webs tend to increase in size and complexity with lake size due to increased resource availability and niche diversity, but small shallow lakes have greater diversity than small deep lakes due to habitat heterogeneity and light penetration to the bottm allowing development of benthic macrophytes and associated biota. Salt lakes may have high productivity but simple trophic structures, with high abundances of few species. Invertebrate detritivores consume fragments of organic matter, providing resources for macroinvertebrates, fish, waterbirds, reptiles and mammals. Species traits appear to be strongly influenced by environmental filtering by the water regime (e.g. cold tolerance and seasonal dormancy occurs in freeze-thaw lakes and desiccation tolerance and dormant life stages dominate in ephemeral lakes) and water chemistry (i.e. tolerance to salinity in salt lakes).
